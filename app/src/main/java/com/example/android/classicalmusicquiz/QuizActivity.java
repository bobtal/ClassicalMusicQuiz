...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // MediaSessionCompat object, set the flags for external clients,
    ...
    private void initializeMediaSession() {
        ...
        // Set an optional MediaButtonReceiver component, set to null since
        // we don't want a media button to start our app if it's been stopped.
        ...
        // End the session when it's no longer needed (in onDestroy)
    }
